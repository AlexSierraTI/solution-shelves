...
SOLUTION_SHELVES_VULKAN_VERSION = '1.2.170.0'
VULKAN_SDK_EXE_PATH = 'SolutionShelves/vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
	if (VULKAN_SDK is None):
		...
		InstallVulkanPrompt()
		return false
	elif (SOLUTION_SHELVES_VULKAN_VERSION not in VULKAN_SDK):
		print(f"Located Vulkan SDK at {VULKAN_SDK}")
		print(f"You don't have the correct Vulkan SDK version! (Solution Shelves requires {SOLUTION_SHELVES_VULKAN_VERSION}")
		InstallVulkanPrompt()
		return False
...
OutputDirectory = "SolutionShelves/vendor/VulkanSDK"
